# Traffic Flow Prediction and Dynamic Routing in Bangladesh's Urban Transport Networks using Graph Neural Networks
...
A[Dhaka Road Network from OpenStreetMap]

A --> B[Road Segment Extraction]

B --> C[Static Feature Generation]

C --> D[Synthetic Traffic Generation]

D --> E[Traffic Time Series Dataset]

E --> F[Line Graph Construction]

F --> G[Graph Convolution Network]

G --> H[Transformer Encoder]

H --> I[Prediction Head]

I --> J[Future Traffic Forecast]

J --> K[Performance Evaluation]

K --> L[Visualization and Analysis]
```
...
Contains static road segment information.
...
Contains temporal indexing information.
...
Contains dynamic traffic observations.
...
The model successfully captures both spatial and temporal traffic patterns, producing accurate short-term traffic forecasts.

---

## Statistical Validation

The forecasting model is evaluated using statistical significance testing.
...
- Constructs the graph representation
